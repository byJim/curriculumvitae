...
const SkillsSpan = styled.span`
  ...
  overflow: hidden;
  position: relative;
  box-shadow: inset 0 2px 9px rgba(255,255,255,0.4), inset 0 -2px 6px rgba(0,0,0,0.4);
  ...
  &:after{
    ...
    transparent 25%, transparent 50%, rgba(255,255,255,0.2) 50%, rgba(255,
    255,255,0.2)75%, transparent 75%,transparent); 
    z-index: 1;
